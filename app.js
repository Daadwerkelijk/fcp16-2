...
// Labels uniform getrokken naar 6 Nederlandse rollen (Keeper/CV/VV/MID/AM/
// AANV, met -L/-C/-R/-CL/-CR waar nodig) — voorheen verzon elke formatie
// z'n eigen vocabulaire (VM/DM/CM/LW/RW/CF/LAM/CAM/RAM naast het Nederlandse
// DEF/MID/AANV van de kleinere spelvormen), waardoor "Passende positie
// eerst" (openOpstSlotKiezer, index.html) bij kleinere spelvormen nooit iets
// vond en bij 11-tegen-11 alleen bij toevallig gelijke labels. `id` blijft
// ongewijzigd (die zit al in opgeslagen wed_lineup-data), alleen `label`
// (het zichtbare pil-tekstje + waar spelers hun voorkeurspositie op taggen)
// is aangepast. Afgestemd met gebruiker 2026-09-14.
const FORMATIES_BUILTIN = {
  '4222': { label:'4-2-2-2', spelvorm:11, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'LB',   label:'VV-L',  role:'back',   x:14, y:72},
    {id:'CB_L', label:'CV-L',  role:'cb',     x:36, y:75},
    {id:'CB_R', label:'CV-R',  role:'cb',     x:64, y:75},
    {id:'RB',   label:'VV-R',  role:'back',   x:86, y:72},
    {id:'VM_L', label:'MID-L', role:'dm',     x:36, y:53},
    {id:'VM_R', label:'MID-R', role:'dm',     x:64, y:53},
    {id:'AM_L', label:'AM-L',  role:'am',     x:24, y:36},
    {id:'AM_R', label:'AM-R',  role:'am',     x:76, y:36},
    {id:'ST_L', label:'AANV-L',role:'st',     x:14, y:16},
    {id:'ST_R', label:'AANV-R',role:'st',     x:86, y:16},
  ]},
  '14231': { label:'4-2-3-1', spelvorm:11, pos:[
    ...
    {id:'CB_R',label:'CV-R',  role:'cb',     x:64, y:75},
    {id:'RB',  label:'VV-R',  role:'back',   x:86, y:72},
    {id:'DM_L',label:'MID-L', role:'dm',     x:38, y:57},
    {id:'DM_R',label:'MID-R', role:'dm',     x:62, y:57},
    {id:'LAM', label:'AM-L',  role:'am',     x:18, y:38},
    {id:'CAM', label:'AM-C',  role:'am',     x:50, y:38},
    {id:'RAM', label:'AM-R',  role:'am',     x:82, y:38},
    {id:'CF',  label:'AANV-C',  role:'st',     x:50, y:16},
  ]},
  '433a': { label:'4-3-3 (punt achter)', spelvorm:11, pos:[
    ...
    {id:'CB_R',label:'CV-R',  role:'cb',     x:64, y:75},
    {id:'RB',  label:'VV-R',  role:'back',   x:86, y:72},
    {id:'CM_L',label:'MID-L', role:'dm',     x:22, y:52},
    {id:'CM_C',label:'MID-C', role:'dm',     x:50, y:60},
    {id:'CM_R',label:'MID-R', role:'dm',     x:78, y:52},
    {id:'LW',  label:'AM-L',  role:'am',     x:14, y:28},
    {id:'ST',  label:'AANV-C',  role:'st',     x:50, y:16},
    {id:'RW',  label:'AM-R',  role:'am',     x:86, y:28},
  ]},
  '352': { label:'3-5-2 (punt voor)', spelvorm:11, pos:[
    {id:'GK',  label:'GK',    role:'keeper', x:50, y:88},
    {id:'CB_L',label:'CV-L',  role:'cb',     x:26, y:75},
    {id:'CB_C',label:'CV-C',  role:'cb',     x:50, y:78},
    {id:'CB_R',label:'CV-R',  role:'cb',     x:74, y:75},
    {id:'LWB', label:'VV-L',  role:'back',   x:10, y:55},
    {id:'CM_L',label:'MID-L', role:'dm',     x:32, y:55},
    {id:'CM_C',label:'MID-C', role:'dm',     x:50, y:60},
    {id:'CM_R',label:'MID-R', role:'dm',     x:68, y:55},
    {id:'RWB', label:'VV-R',  role:'back',   x:90, y:55},
    {id:'ST_L',label:'AANV-L',role:'st',     x:36, y:22},
    {id:'ST_R',label:'AANV-R',role:'st',     x:64, y:22},
  ]},
  '13421': { label:'3-4-2-1', spelvorm:11, pos:[
    ...
    {id:'CB_C',label:'CV-C',   role:'cb',     x:50, y:78},
    {id:'CB_R',label:'CV-R',   role:'cb',     x:74, y:75},
    {id:'LM',  label:'MID-L',  role:'dm',     x:10, y:57},
    {id:'CM_L',label:'MID-CL', role:'dm',     x:36, y:60},
    {id:'CM_R',label:'MID-CR', role:'dm',     x:64, y:60},
    {id:'RM',  label:'MID-R',  role:'dm',     x:90, y:57},
  ...
  '442v': { label:'4-4-2 vlak', spelvorm:11, pos:[
    ...
    {id:'CB_R',label:'CV-R',   role:'cb',     x:64, y:75},
    {id:'RB',  label:'VV-R',   role:'back',   x:86, y:72},
    {id:'LM',  label:'MID-L',  role:'dm',     x:14, y:52},
    {id:'CM_L',label:'MID-CL', role:'dm',     x:38, y:55},
    {id:'CM_R',label:'MID-CR', role:'dm',     x:62, y:55},
    {id:'RM',  label:'MID-R',  role:'dm',     x:86, y:52},
    {id:'ST_L',label:'AANV-L', role:'st',     x:36, y:20},
    {id:'ST_R',label:'AANV-R', role:'st',     x:64, y:20},
  ]},
  '442r': { label:'4-4-2 ruit', spelvorm:11, pos:[
    ...
    {id:'RB',  label:'VV-R',  role:'back',   x:86, y:72},
    {id:'LM',  label:'MID-L', role:'dm',     x:14, y:52},
    {id:'CM_A',label:'AM-C',  role:'am',     x:50, y:40},
    {id:'CM_V',label:'MID-C', role:'dm',     x:50, y:60},
    {id:'RM',  label:'MID-R', role:'dm',     x:86, y:52},
    {id:'ST_L',label:'AANV-L',role:'st',     x:36, y:20},
    {id:'ST_R',label:'AANV-R',role:'st',     x:64, y:20},
  ]},
  '532': { label:'5-3-2', spelvorm:11, pos:[
    {id:'GK',  label:'GK',    role:'keeper', x:50, y:88},
    {id:'LWB', label:'VV-L',  role:'back',   x:8,  y:68},
    {id:'CB_L',label:'CV-L',  role:'cb',     x:28, y:75},
    {id:'CB_C',label:'CV-C',  role:'cb',     x:50, y:78},
    {id:'CB_R',label:'CV-R',  role:'cb',     x:72, y:75},
    {id:'RWB', label:'VV-R',  role:'back',   x:92, y:68},
    {id:'CM_L',label:'MID-L', role:'dm',     x:28, y:52},
    {id:'CM_C',label:'MID-C', role:'dm',     x:50, y:55},
    {id:'CM_R',label:'MID-R', role:'dm',     x:72, y:52},
    {id:'ST_L',label:'AANV-L',role:'st',     x:36, y:22},
    {id:'ST_R',label:'AANV-R',role:'st',     x:64, y:22},
  ]},
  '433b': { label:'4-3-3 (punt voor)', spelvorm:11, pos:[
    ...
    {id:'CB_R',label:'CV-R',  role:'cb',     x:64, y:75},
    {id:'RB',  label:'VV-R',  role:'back',   x:86, y:72},
    {id:'CM_L',label:'MID-L', role:'dm',     x:36, y:55},
    {id:'CM_C',label:'AM-C',  role:'am',     x:50, y:45},
    {id:'CM_R',label:'MID-R', role:'dm',     x:64, y:55},
    {id:'LW',  label:'AM-L',  role:'am',     x:14, y:28},
    {id:'ST',  label:'AANV-C',  role:'st',     x:50, y:16},
    {id:'RW',  label:'AM-R',  role:'am',     x:86, y:28},
  ]},
  ...
  // MID/AANV-labels stonden hier al Nederlands en zijn ongewijzigd; alleen
  // DEF(-L/-C/-R) is naar VV/CV getrokken zodat het met de grote formaties
  // matcht.
  'sv4_22': { label:'2-2', spelvorm:4, pos:[
    {id:'ACHT_L',label:'VV-L',  role:'back', x:30, y:65},
    {id:'ACHT_R',label:'VV-R',  role:'back', x:70, y:65},
    {id:'VOOR_L',label:'AANV-L',role:'st',   x:30, y:30},
    {id:'VOOR_R',label:'AANV-R',role:'st',   x:70, y:30},
  ]},

  'sv6_212': { label:'2-1-2', spelvorm:6, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:30, y:68},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:70, y:68},
    {id:'MID',  label:'MID-C',   role:'dm',     x:50, y:48},
    {id:'AANV_L',label:'AANV-L',role:'st',    x:32, y:22},
    {id:'AANV_R',label:'AANV-R',role:'st',    x:68, y:22},
  ]},
  'sv6_131': { label:'1-3-1', spelvorm:6, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF',  label:'CV-C',    role:'cb',     x:50, y:68},
    {id:'MID_L',label:'MID-L', role:'dm',     x:25, y:45},
    {id:'MID_C',label:'MID-C', role:'dm',     x:50, y:48},
    {id:'MID_R',label:'MID-R', role:'dm',     x:75, y:45},
    {id:'AANV', label:'AANV-C',  role:'st',     x:50, y:20},
  ]},
  'sv6_221': { label:'2-2-1', spelvorm:6, pos:[
    ...
    {id:'AANV', label:'AANV-C',  role:'st',     x:50, y:18},
  ]},

  'sv7_321': { label:'3-2-1', spelvorm:7, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:25, y:68},
    {id:'DEF_C',label:'CV-C',    role:'cb',     x:50, y:72},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:75, y:68},
  ...
  'sv7_231': { label:'2-3-1', spelvorm:7, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:32, y:68},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:68, y:68},
  ...
  'sv8_331': { label:'3-3-1', spelvorm:8, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:22, y:70},
    {id:'DEF_C',label:'CV-C',    role:'cb',     x:50, y:74},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:78, y:70},
  ...
  'sv8_232': { label:'2-3-2', spelvorm:8, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:30, y:70},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:70, y:70},
    {id:'MID_L',label:'MID-L', role:'dm',     x:20, y:46},
    {id:'MID_C',label:'MID-C', role:'dm',     x:50, y:48},
    {id:'MID_R',label:'MID-R', role:'dm',     x:80, y:46},
    {id:'AANV_L',label:'AANV-L',role:'st',    x:35, y:18},
  ...
  'sv9_332': { label:'3-3-2', spelvorm:9, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:22, y:72},
    {id:'DEF_C',label:'CV-C',    role:'cb',     x:50, y:76},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:78, y:72},
  ...
  'sv9_233': { label:'2-3-3', spelvorm:9, pos:[
    {id:'GK',   label:'GK',    role:'keeper', x:50, y:88},
    {id:'DEF_L',label:'VV-L',  role:'back',   x:32, y:70},
    {id:'DEF_R',label:'VV-R',  role:'back',   x:68, y:70},
    {id:'MID_L',label:'MID-L', role:'dm',     x:22, y:46},
    {id:'MID_C',label:'MID-C', role:'dm',     x:50, y:48},
    {id:'MID_R',label:'MID-R', role:'dm',     x:78, y:46},
